%Script to preprocess Sheila's data alone participants. Version3
...
addpath(genpath('/Users/marinabroomfield/Desktop/CurrentFolder/eeglab2020_0'))
...
for j=1;
    ...
    for i=1:length(file_name)
        ...
        %EEGSET = pop_importdata('dataformat','ascii','nbchan',28,'data', filesList(i).name ,'srate',248,'pnts',0,'xmin',0,'chanlocs',[currentDirectory '/chanloc28.ced']);
    ...
    nameerp = [name_temp(1:2) '_S' int2str(j) '_alone' '.erp'];
    nameset = [name_temp(1:2) '_S' int2str(j) '_alone' '.set'];
    EEG = pop_editset(EEG, 'run', [], 'chanlocs', [pwd '/Chanloc28.ced']);%load channel location info
...
% %end
% 
>>>>>>> 6dcb0e646714f8c87313df484282916759367681
